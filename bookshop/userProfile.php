...
<head>
    ...
    <title>User Profile | Unicorn</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if (isset($_SESSION["i"])) {
                ...
                $details_rs = Connection::select("SELECT * FROM `user` INNER JOIN `gender` 
                ON `user`.`gender_gender_id`=`gender`.`gender_id` 
                WHERE `email`='" . $email . "'");

                $img_rs = Connection::select("SELECT * FROM `profile_img` WHERE `user_email`='" . $email . "'");

                $address_rs = Connection::select("SELECT * FROM `user_has_address` INNER JOIN `city` 
                ...
                $image_details = $img_rs->fetch_assoc();
                $address_details = $address_rs->fetch_assoc();

            ?>
                <div class="col-12" style="background-color: #c5e1fa;background-image: linear-gradient(90deg,#c5e1fa 0%,#376894 100%);">
                    <div class="row">

                        <div class="col-12 bg-body rounded mt-4 mb-4 bg-info bg-opacity-25">
                            <div class="row g-2">
                                ...
                                <div class="col-md-8 bg-primary bg-opacity-25">
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control" id="np" value="<?php echo $user_details["password"]; ?>">
                                                    <div class="input-group-append">
                                                        <button id="npb" class="btn btn-outline-dark" type="button" onclick="showPassword1();"><i class="bi bi-eye-fill"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php
                                            $province_rs = Connection::select("SELECT * FROM `province`");
                                            $district_rs = Connection::select("SELECT * FROM `district`");
                                            $city_rs = Connection::select("SELECT * FROM `city`");
